...
5. Иногда также включается SWOT-анализ.
...
Ниже показан пример пользовательских требований для приложения. В примере используется диаграмма вариантов использования (Use-case), показывающая связи различных сценариев с действующими в процессе лицами (акторами).
...
В большинстве случаев технические требования — это набор документов, описывающих различные уровни и аспекты реализации приложения. В одном документе может описываться бэкенд, в другом — интерфейс пользователя, в третьем — база данных. Это могут быть, например, следующие документы:

* макеты
* списки методов API, составленные с помощью Swagger
* ER-диаграммы для описания баз данных
...
![Collaboration diagram](https://github.com/ilsinyakov/QA_Theory/blob/main/Pictures/collaboration_diagram.png)
