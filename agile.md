...
* [Гибкая методология (Agile) или каскадная модель (Waterfall)](#гибкая-методология-agile-или-каскадная-модель-waterfall)
	...
	* [Гибкая разработка (Agile)](https://github.com/ilsinyakov/QA_Theory/blob/main/agile.md#гибкая-разработка-agile)
	* []
...
Продолжительность ретроспективы - от часа до двух. Присутствие всех членов команды обязательно! Все идеи и мнения записываются (один из возможных вариантов записи - выше на скриншоте) и анализируются. 
