...
* [Типы данных](#типы-данных)
  * [Числовые типы (Numeric Types)](#числовые-типы-numeric-types)
  * [Логический тип (Boolean)](#логический-тип-boolean)
  * [Строки (Strings)](#строки-strings)
  * [Последовательности (Sequence Types)](#последовательности-sequence-types)
  * [Множества (Sets)](#множества-sets)
  * [Словари (Dictionaries)](#словари-dictionaries)
  * [NoneType](#nonetype)
* [Изменяемость (Mutability)](#изменяемость-mutability)
* [ООП](#ооп)
  ...
  * [self](#self)
  * [Переменные (атрибуты) класса и экземпляра](#переменные-атрибуты-класса-и-экземпляра)
  * [classmethod (метод класса)](#classmethod-метод-класса)
  * [staticmethod (статический метод)](#staticmethod-статический-метод)
* [Декораторы](#декораторы)
  * [Определение декоратора](#определение-декоратора)
  * [Пример декоратора](#пример-декоратора)
  * [Применение functools.wraps](#применение-functoolswraps)
  * [Декоратор с аргументами (фабрика декораторов)](#декоратор-с-аргументами-фабрика-декораторов)
  * [Класс-декоратор](#класс-декоратор)
  * [Декораторы и методы (self/cls)](#декораторы-и-методы-selfcls)
  * [Стек декораторов — порядок применения](#стек-декораторов--порядок-применения)
  * [Пример. Таймер](#пример-таймер)
* [Контекстный менеджер](#контекстный-менеджер)
  * [Определение контекстного менеджера](#определение-контекстного-менеджера)
  * [Протокол: `__enter__` и `__exit__`](#протокол-__enter__-и-__exit__)
  * [Пример: работа с файлом](#пример-работа-с-файлом)
  * [Пример собственного контекстного менеджера (класс)](#пример-собственного-контекстного-менеджера-класс)
  * [Пример через contextlib.contextmanager (декоратор)](#пример-через-contextlibcontextmanager-декоратор)
  * [Подавление исключений](#подавление-исключений)
  * [Порядок входа/выхода при нескольких менеджерах](#порядок-входавыхода-при-нескольких-менеджерах)
  * [Пример классовый менеджер / contextmanager](#пример-классовый-менеджер--contextmanager)
