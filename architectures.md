...
* [Многослойная архитектура (монолит)](#многослойная-архитектура-монолит)
* [Многоуровневая архитектура (клиент-сервер)](#многоуровневая-архитектура-клиент-сервер)
  * [Двухуровневая система](#двухуровневая-система)
  * [Трехуровневая и n-уровневая системы](#трехуровневая-и-n-уровневая-системы)
* [Сервис-ориентированная архитектура (SOA)](#сервис-ориентированная-архитектура-soa)
* [Mикросервисная архитектура](#mикросервисная-архитектура)
...
![multi-layered architecture](https://github.com/ilsinyakov/QA_Theory/blob/main/Pictures/multi-layered-architecture.webp?raw=true)
...
![Двухуровневая система](https://github.com/ilsinyakov/QA_Theory/blob/main/Pictures/two-layer.png?raw=true)
...
![Трехуровневая система](https://github.com/ilsinyakov/QA_Theory/blob/main/Pictures/n-layer.webp?raw=true)
...
![SOA](https://github.com/ilsinyakov/QA_Theory/blob/main/Pictures/soa.webp?raw=true)
...
![Микросервисы](https://github.com/ilsinyakov/QA_Theory/blob/main/Pictures/microservises.jpeg?raw=true)

Микросервисы, из которых собираются приложения, должны как можно меньше зависеть друг от друга и при этом быть очень тесно связанными — они содержат собственную доменную логику и работают скорее как фильтры с точки зрения классического Unix: получают запросы, применяют логику и генерируют ответы. Они оркестрируются с помощью простых REST-подобных протоколов
